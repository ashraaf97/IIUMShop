...
export default class OthersProductScreen extends Component {
  ...
  updateIndex = (index) => {
    ...
    if (index==1) {
      ...
      this.props.navigation.navigate('FoodProductScreen')
    } else {
  ...
  componentDidMount(){
    ...
    <SafeAreaView style={styles.container}>
      ...
      <Button
        title="      Food      "
        color="#b90101"
        onPress={() => navigation.navigate('FoodProductScreen')}
      />
      <Button
        title="      Gadget      "
        color="#038807"
